<!-- Masthead-->
<header class="masthead" style="background-image: url(<?php echo base_url('main') ?>/assets/assets/img/upload/produk/<?php echo $this->M_Produk->tampil_top_img_view_more()['gambar'] ?>)">
	<div class="container">
	...
	<div class="container">
		<div class="row text-center">
			...
			<div class="col-md-6 mt-2">
				<img class="img-fluid" src="<?php echo base_url('main') ?>/assets/assets/img/upload/variasi_produk/<?php echo $value['gambar_variasi'] ?>" alt="" />
