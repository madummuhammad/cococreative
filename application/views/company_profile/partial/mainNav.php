              ...
              <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="logo custom_logo">
                    <?php if ($this->uri->segment(1)=='teams'): ?>
                      <a class="d-flex justify-content-between align-items-center" href="<?= base_url() ?>">
                    ...
                    <?php if(get_cookie('lang_is') === 'in'){ ?>
                      <?php if ($this->uri->segment(1)=='teams'): ?>
                        <ul class="nav navbar-nav ml-auto align-items-center">
                          <li class="nav-item"><a class="nav-link btn-navbar" href="<?= base_url() ?>" data-target="body">Beranda</a></li>
                          <li class="nav-item active"><a href="<?= base_url('teams') ?>" class="nav-link btn-navbar">Tim</a></li>
                        </ul>
                      <?php else: ?>
                        <ul class="nav navbar-nav ml-auto align-items-center">
                    ...
                    <?php } else { ?>
                      <?php if ($this->uri->segment(1)=='teams'): ?>
                        <ul class="nav navbar-nav ml-auto align-items-center">
                          ...
                          <li class="nav-item active"><a href="<?= base_url('teams') ?>" class="nav-link btn-navbar">Teams</a></li>
                        </ul>
                      <?php else: ?>
                        <ul class="nav navbar-nav ml-auto align-items-center">
                          <li class="nav-item"><a class="nav-link btn-navbar" data-target="body">Home</a></li>
