...
<!-- 									<h4 id="harga"></h4>
									...
									<form action="<?php echo base_url('Order') ?>" method="POST">
										<input type="text" class="form-control" value="<?php echo $value['nama_jenis_produk'];echo ' '.$value['isi_pilihan_ukuran'] ?>" name="product" readonly="" hidden>
										<input type="text" name="size" value="<?php echo $value['harga'] ?>" readonly="" hidden>
