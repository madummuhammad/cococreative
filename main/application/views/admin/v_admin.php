...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4 col-lg-5">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-danger">
                                <?php echo $this->M_Pengunjung->pengunjung_bulan_ini() ?>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-9 col-lg-7">
            <!--                                 <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Pengunjung Perbulan</h6>
                </div>
                <div class="card-body">
                    <div class="chart-bar">
